      ...
      <div class="row">
	       <div class="col-sm-12">
		         <div class="full-right">
			            <h2>Riwayat Pembelian <a class="btn btn-sm btn-danger" style="margin-left:10px;" href="<?php echo e(route('users.index')); ?>">HOME</a></h2>
		         </div>
	       </div>
      </div>
          ...
          <th width="210px">Actions</th>
                ...
                <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><a class="btn btn-sm btn-primary" href="<?php echo e(route('users.detail', $data->id)); ?>">Detail</a></td>
                  </tr>
